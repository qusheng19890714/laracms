        ...
        <form class="form form-config form-sm" action="{{route('install.config')}}">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="admin[username]" value="admin" readonly required="required">
                </div>
                <div class="form-group col-md-6">
                    <label for="admin[password]">{{trans("installer.config.admin.password")}}</label>
                    <input type="text" class="form-control" name="admin[password]" value="admin" readonly required="required">
                </div>
            </div>
            <div class="form-group">
